...
export const DropdownDrivers = ({ driver }: {
    driver: Driver
}) => {
        ...
        <>
            ...
            <Dialog open={showDelete} onOpenChange={setShowDelete}>
                <DialogContent className="sm:max-w-[425px]">
                    <DialogHeader>
                        <DialogTitle>Eliminar Conuctor</DialogTitle>
                        <DialogDescription>
                            ¿Estás seguro de que deseas eliminar al conductor &quot;{driver.name}&quot;? Esta acción no se puede deshacer.
                        </DialogDescription>
                    </DialogHeader>
